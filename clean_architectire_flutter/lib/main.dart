...
import 'package:clean_architectire_flutter/features/feed/presentation/pages/feed_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  FeedPage(getArticles: GetArticles(MockRemoteArticleRepository())),
    );
  }
}
